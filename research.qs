...
const SieceTree = function () {
	...
	s.addNext(new Research(2, "🔋Аккумуляторы", "Открывает доступ к строительству 🔋Аккумуляторов", "enable_accum", 1000, 120000, 0)).
	  ...
	  addNext(new Research(6, "🔌Экономия энергии 3", "На 10% сокращает потребление электричества", "eco_power", 10000, 2000000, 8000)).
	  addNext(new Research(7, "🔌Экономия энергии 4", "На 10% сокращает потребление электричества", "eco_power", 10000, 2200000, 24000));
	s.children[0].addNext(new Research(8, "🔋Улучшеные аккумуляторы", "Увеличивает ёмкость аккумуляторов на 20%", "upgrade_accum", 5000, 1000000, 4000));
